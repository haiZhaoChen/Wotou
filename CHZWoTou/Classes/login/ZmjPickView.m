...
//    _addressLb.text = _shengArray[0][@"name"];
}
...
//        
//        if ([_xianArray[i][@"pid"] integerValue] == index) {
//            
...
//                               _xianArr.count > 0? _xianArr[xianRow][@"name"]:@"");
        ...
        self.determineBtnBlock(_shengArray[shengRow][@"name"],_shiArr.count > 0? _shiArr[shiRow][@"name"]:@"");
