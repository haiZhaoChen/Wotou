...
@property (nonatomic, strong) MPMoviePlayerController *tempPlayer;
...
//
        ...
        [self.play setImage:[UIImage imageNamed:@"stop"] forState:UIControlStateSelected];
...
//        self.back.backgroundColor = [UIColor blackColor];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(videoFinished:) name:MPMoviePlayerPlaybackDidFinishNotification object:self.moviePlayer];
        ...
        MPVolumeView *volum = [[MPVolumeView alloc]initWithFrame:CGRectMake(-100, -100, 30, 30)];
...
//        _tempPlayer = [[MPMoviePlayerController alloc] init];
//        _tempPlayer.view.frame = self.bounds;
...
//    [_tempPlayer setContentURL:url];
    [self.moviePlayer requestThumbnailImagesAtTimes:@[@20.0] timeOption:MPMovieTimeOptionNearestKeyFrame];
    [[NSNotificationCenter defaultCenter] addObserver:self
...
{
    [[CHZBookMusViewController shareBookMusViewController].player stop];
    _imgBgView.hidden = YES;
