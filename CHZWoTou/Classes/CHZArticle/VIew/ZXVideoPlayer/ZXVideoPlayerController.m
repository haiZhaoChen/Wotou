...
//    }
    ...
    self.frame = CGRectMake(0, 55, kScreenWidth, kScreenWidth *0.55);
...
- (void)fullScreenButtonClick
{
    ...
    if ([self.delegate respondsToSelector:@selector(fullScreenBtnClick)]) {
        [self.delegate fullScreenBtnClick];
    }
...
- (void)shrinkScreenButtonClick
{
    ...
    if ([self.delegate respondsToSelector:@selector(unFullScreenBtnClick)]) {
        [self.delegate unFullScreenBtnClick];
    }
